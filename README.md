...
| **5. Demo Video Links** | 6-Part Animated WebP Walkthrough Suite | [Demo Section](#-product-demo-recordings) · [Walkthrough Guide (`docs/demo-video.md`)](./docs/demo-video.md) |
...
- **User Onboarding Methodology**: [`docs/user-testing.md`](./docs/user-testing.md)
